namespace Tests
{
    ...
    public class DoublyLinkedListTests
    {
        ...
        public void LinkedList_ContainsTwoPrivateNodes()
        {
            ...
            var nestedTypes = linkedListType.GetNestedTypes(BindingFlags.NonPublic);
            var nodeFields = nestedTypes[0].GetFields(BindingFlags.Instance | BindingFlags.NonPublic)
                .Where(f => f.FieldType.Name.Contains("Node"))
                .ToList();
            Assert.AreEqual(2, nodeFields.Count);
        }
